...
\usepackage[T1]{fontenc} % kopírovanie textu s pdf v správnom formáte
\usepackage{tocloft}
\usepackage{tocbasic}
\usepackage{tabularx}
\usepackage{lipsum}
...
\addto\captionsslovak{
	...
	\counterwithin{figure}{section}  % štruktúrované číslovanie obrázkov
}
...
\begin{document}
\input{titulna_strana} % vloženie súboru s titulnou stranou, takto je možné pridávať súbory ktoré obsahujú časti práce
